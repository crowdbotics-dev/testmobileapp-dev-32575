...
## Project Structure
    ...
    ├── testmobileapp_dev_32575  # Django project configurations
...
1. Clone this repo and `cd testmobileapp_dev_32575`
...
2. Clone this repo and `cd testmobileapp_dev_32575`
